...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public class JsonColumn : Column
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual Column? FindColumn(IForeignKey ownership, string columnName)
            => _containedColumns.TryGetValue(ownership, out var inner)
                && inner.TryGetValue(columnName, out var result)
            ? result
            : null;
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual void AddColumn(IForeignKey ownership, string columnName, Column column)
        {
