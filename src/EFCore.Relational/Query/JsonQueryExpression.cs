...
namespace Microsoft.EntityFrameworkCore.Query
{
    ...
    public class JsonQueryExpression : Expression, IPrintableExpression
    {
        ...
        /// TODO
        /// </summary>
        public JsonQueryExpression Update(ColumnExpression jsonColumn, IReadOnlyDictionary<IProperty, ColumnExpression> keyPropertyMap, IReadOnlyList<string> jsonPath)
            => jsonColumn != JsonColumn
