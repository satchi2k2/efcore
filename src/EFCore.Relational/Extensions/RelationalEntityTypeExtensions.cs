...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    /// TODO
    /// </summary>
    public static void SetJsonColumnTypeName(this IMutableEntityType entityType, string typeName)
        => entityType.SetOrRemoveAnnotation(RelationalAnnotationNames.JsonColumnTypeName, typeName);
    ...
    /// TODO
    /// </summary>
    public static ConfigurationSource? GetJsonColumnTypeNameConfigurationSource(this IConventionEntityType entityType)
        => entityType.FindAnnotation(RelationalAnnotationNames.JsonColumnTypeName)
            ?.GetConfigurationSource();

    /// <summary>
    ///     TODO
    /// </summary>
    public static string? JsonColumnTypeName(this IEntityType entityType)
        => entityType.FindAnnotation(RelationalAnnotationNames.JsonColumnTypeName)?.Value as string;

    /// <summary>
    ///     TODO
    /// </summary>
    public static string? JsonColumnTypeName(this IMutableEntityType entityType)
        => entityType.FindAnnotation(RelationalAnnotationNames.JsonColumnTypeName)?.Value as string;

    /// <summary>
    ///     TODO
    /// </summary>
    public static string? JsonColumnTypeName(this IConventionEntityType entityType)
        => entityType.FindAnnotation(RelationalAnnotationNames.JsonColumnTypeName)?.Value as string;

    /// <summary>
    ///     TODO
    /// </summary>
    public static string? JsonColumnTypeName(this IReadOnlyEntityType entityType)
        => entityType.FindAnnotation(RelationalAnnotationNames.JsonColumnTypeName)?.Value as string;
