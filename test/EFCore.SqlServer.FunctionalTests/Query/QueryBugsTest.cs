...
WHERE [e].[TimeSpan] = @__parameter_0");
    ...
    public void JsonTest()
    {
        ...
        using (var ctx = new MyContext())
        {
            //var query00 = ctx.MyEntities.Select(x => x).ToList();
            //var query01 = ctx.MyEntities.Select(x => x.OwnedReferenceSharedRoot.OwnedReferenceSharedBranch).AsNoTracking().ToList();
            //var query02 = ctx.MyEntities.Select(x => x.OwnedReferenceSharedRoot).AsNoTracking().ToList();
            //var query03 = ctx.MyEntities.Select(x => x.OwnedCollectionSharedRoot).AsNoTracking().ToList();
            //var query04 = ctx.MyEntities.Select(x => x.OwnedReferenceSharedRoot.OwnedReferenceSharedBranch.OwnedCollectionSharedLeaf).AsNoTracking().ToList();
            //var query04ipol = ctx.MyEntities.Select(x => x.OwnedReferenceSharedRoot.OwnedReferenceSharedBranch.OwnedReferenceSharedLeaf).AsNoTracking().ToList();

            //var query05 = ctx.MyEntities.Select(x => new
            //{
            ...
            //var query06 = ctx.MyEntities.AsNoTracking().Select(x => x.OwnedReferenceSharedRoot.OwnedReferenceSharedBranch.Date).ToList();
            //var query07 = ctx.MyEntities.Where(x => x.OwnedReferenceSharedRoot.OwnedReferenceSharedBranch.Fraction < 20.5M).Select(x => x.Id).ToList();
            ...
            //}).AsNoTracking().ToList();
            //var query09 = ctx.MyEntities.Select(x => x.OwnedReferenceSharedRoot.OwnedReferenceSharedBranch.OwnedReferenceSharedLeaf.SomethingSomething).Take(3).Distinct().Select(x => x.Length).ToList();
