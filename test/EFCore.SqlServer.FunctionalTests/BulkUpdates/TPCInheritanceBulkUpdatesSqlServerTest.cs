...
public class TPCInheritanceBulkUpdatesSqlServerTest : TPCInheritanceBulkUpdatesTestBase<TPCInheritanceQuerySqlServerFixture>
{
    public TPCInheritanceBulkUpdatesSqlServerTest(TPCInheritanceQuerySqlServerFixture fixture)
        : base(fixture)
    {
        ClearLog();
    }
