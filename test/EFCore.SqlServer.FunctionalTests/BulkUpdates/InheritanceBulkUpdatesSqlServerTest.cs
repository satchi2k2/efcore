...
public class InheritanceBulkUpdatesSqlServerTest : InheritanceBulkUpdatesTestBase<InheritanceQuerySqlServerFixture>
{
    public InheritanceBulkUpdatesSqlServerTest(InheritanceQuerySqlServerFixture fixture)
        : base(fixture)
    {
        ClearLog();
    }
