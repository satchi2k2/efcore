...
public class TPCFiltersInheritanceBulkUpdatesSqlServerTest : TPCFiltersInheritanceBulkUpdatesTestBase<TPCFiltersInheritanceQuerySqlServerFixture>
{
    public TPCFiltersInheritanceBulkUpdatesSqlServerTest(TPCFiltersInheritanceQuerySqlServerFixture fixture)
        : base(fixture)
    {
        ClearLog();
    }
