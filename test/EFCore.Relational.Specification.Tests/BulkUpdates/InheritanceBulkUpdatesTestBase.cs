...
public abstract class InheritanceBulkUpdatesTestBase<TFixture> : BulkUpdatesTestBase<TFixture>
    where TFixture : InheritanceQueryFixtureBase, IBulkUpdatesFixtureBase, new()
{
    ...
    public virtual Task Delete_where_keyless_entity_mapped_to_sql_query(bool async)
        => AssertTranslationFailed(
            RelationalStrings.BulkOperationOnKeylessEntityTypeWithUnsupportedOperator("BulkDelete", "EagleQuery"),
            () => AssertDelete(
                async,
