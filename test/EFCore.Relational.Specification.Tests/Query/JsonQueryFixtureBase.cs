...
public abstract class JsonQueryFixtureBase : SharedStoreFixtureBase<JsonQueryContext>, IQueryFixtureBase
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
    {
        ...
        {
            // this doesn't work
            //b.Property(x => x.OwnedReferenceSharedBranch).HasColumnType("jsonb");

            // should we do it like this?
            //b.ToJson().WithColumnType("jsonb");
            // we prolly shouldn't cram them both into one method,
            // because we want to enable not passing the json column name
            b.ToJson();
