...
public class InheritanceBulkUpdatesSqliteTest : InheritanceBulkUpdatesTestBase<InheritanceQuerySqliteFixture>
{
    public InheritanceBulkUpdatesSqliteTest(InheritanceQuerySqliteFixture fixture)
        : base(fixture)
    {
        ClearLog();
    }
