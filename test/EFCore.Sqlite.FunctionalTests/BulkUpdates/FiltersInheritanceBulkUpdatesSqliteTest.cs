...
public class FiltersInheritanceBulkUpdatesSqliteTest : FiltersInheritanceBulkUpdatesTestBase<FiltersInheritanceQuerySqliteFixture>
{
    public FiltersInheritanceBulkUpdatesSqliteTest(FiltersInheritanceQuerySqliteFixture fixture)
        : base(fixture)
    {
        ClearLog();
    }
